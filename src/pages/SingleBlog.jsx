          ...
          <div class="flex flex-col md:flex-row -mx-4">
            <div class="md:flex-1 px-4">
              ...
              <div class="flex -mx-2 mb-4">
                ...
                <div class="w-1/2 px-2">
                  <button class="w-full bg-red-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-gray-600">
                    Delete
                  </button>
                </div>
              </div>
